...
<script>
	...
	var fetchList = function(){
		...
		$.ajax({
			async:true,
			url:"/guestbook/api/ajax-list?page=" + page,
			type:"get",
			dateType:"json",
			data:"",
	...
	$(function(){
		var dialogDelete = $("#dialog-delete-form").dialog({
			...
			buttons: {
				"삭제": function(){
					...
					$.ajax({
						async: true,
						url: "/guestbook/api/ajax-delete?page=" + page + "&password=" + $("#password-delete").val() + "&no=" + $("#hidden-no").val(),
						type: "get",
						dataType: "json",
						data: "",
						success: function(response){
		...
		$("#add-form").submit(function(event){
			...
			$.ajax({
				async: true,
				url: "/guestbook/api/ajax-insert/" + page + "/" + $("#input-name").val() + "/" + $("#input-password").val() + "/" + $("#tx-content").val(),
				type: "get",
				dataType: "json",
				data: "",
				success: function(response){
